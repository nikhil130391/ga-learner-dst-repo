...
#Calling the function to read file  
message_a = read_file(file_path_1)
#Calling the function to read file
message_b = read_file(file_path_2)

#Calling the function 'fuse_msg'
secret_msg_1 = fuse_msg(message_a, message_b)
...
#Calling the function to read file
message_c = read_file(file_path_3)

#Calling the function 'substitute_msg'
secret_msg_2 = substitute_msg(message_c)
...
#Calling the function to read file
message_d = read_file(file_path_4)

#Calling the function to read file
message_e = read_file(file_path_5)

#Calling the function 'compare messages'
secret_msg_3 = compare_msg(message_d, message_e)
...
#Calling the function to read file
message_f = read_file(file_path_6)

#Calling the function 'filter_msg'
secret_msg_4 = extract_msg(message_f)
